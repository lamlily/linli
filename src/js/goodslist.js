    ...
    $('header').load('common_header.html',function(){
        if(username){
            ...
            $('header #out').click(function() {
                ...
                location.href="http://localhost:8098/lily-personalpc/src/html/goodslist.html";
            });        
        }
            // // 点击logo跳转到首页
            ...
            $('.toIndex').click(function() {
                console.log(123);
                if(username){
                    location.href="http://localhost:8098/lily-personalpc/src/index.html?username="+username;
                }else{
                    location.href="http://localhost:8098/lily-personalpc/src/index.html?";
                }
            });
