...
jQuery(function($){
    ...
    if(username){
        ...
        //跳转到购物车结算（补充）
         $('#checkout').click(function() {
            console.log(000);
           location.href='http://localhost:8098/lily-personalpc/src/html/shoppingCar.html?username='+username;
        });
        ...
        $('nav').on('click','a',function(e){
           ...
           location.href='http://localhost:8098/lily-personalpc/src/html/goodslist.html?username='+username+'&name='+params;
        });
    ...
    // 跳到详情页（无）
        $('#hotSales').delegate('.ToDetail','click',function(e){
            ...
            id=encodeURI(id);
            console.log(id);
           location.href='http://localhost:8098/lily-personalpc/src/html/details.html?username='+username+'&id='+id;
        });
    ...
    // 侧栏购物车跳到结算页面
        ...
        // 跳到列表页
            $('nav').on('click','a',function(e){
                let params=encodeURI(this.innerText);
               location.href='http://localhost:8098/lily-personalpc/src/html/goodslist.html?name='+params;
            });
        ...
        // 跳到详情页
            $('#hotSales').delegate('.ToDetail','click',function(e){
                ...
                id=encodeURI(id);
                console.log(id);
               location.href='http://localhost:8098/lily-personalpc/src/html/details.html?id='+id;
            });
    ...
    let datalist='';
    // 发送请求获取数据库所有数据，生成页面(无)
        $.ajax({
            url : 'api/index.php',
            type : 'get',
            // async : true,
            data : {goodslists:"goodslist"},
    ...
    // 跳到注册页面
    $('#reg').click(function() {
        location.href="http://localhost:8098/lily-personalpc/src/html/register.html";
    });
